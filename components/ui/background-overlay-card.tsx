    ...
    <div className="w-full max-w-sm lg:max-w-md">
      ...
      >
        <div className="text relative z-50">
          <h1 className="font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-50 relative">
            Background Overlays
          </h1>
          <p className="font-normal text-sm sm:text-base text-gray-50 relative my-3 sm:my-4">
